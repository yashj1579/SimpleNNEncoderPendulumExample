...
[![Watch the video](https://img.youtube.com/vi/70_pbzAYHUY/hqdefault.jpg)](https://youtu.be/70_pbzAYHUY)


**Description:**  
This video shows the actual pendulum (green) swinging alongside the predicted trajectory (purple) generated by the trained neural network.  
The orange trailing points indicate the previous states used for prediction. This visualization demonstrates how well the model learned to forecast the pendulum's motion.
...
3. Animate the pendulum showing:
   * Previous trajectory (orange)
   * True pendulum trajectory (green)
